#!/usr/bin/env python3
"""Aggregate per-subject random-10-fold Kastner ROI decoding results (n=30, Bo et al. 2021
CV scheme, 100 repeats -- matching the paper's exact repeat count) and add group-level
statistics. Mirrors aggregate_roi_decoding_random10fold.py exactly, pointed at the
100-repeat output tree.
"""
...
ROOT = Path("/mnt/n/Experimental_Data/yujunchen/projects/AI_IAPS/new_pipeline/roi_decoding_random10fold_100rep")
OUT = ROOT / "group"
...
def main() -> None:
    ...
    chart_data = {
        ...
        "chance": CHANCE,
        "cv_scheme": "random 10-fold x100 repeats (Bo et al. 2021 scheme, exact repeat count)",
