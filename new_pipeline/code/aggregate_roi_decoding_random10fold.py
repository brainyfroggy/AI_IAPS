#!/usr/bin/env python3
"""Aggregate per-subject random-10-fold Kastner ROI decoding results (n=29, Bo et al. 2021
CV scheme, 30 repeats) and add group-level statistics. Mirrors aggregate_roi_decoding.py
(the leave-one-run-out version) exactly, just pointed at the random-10-fold output tree.
"""
...
ROOT = Path("/mnt/n/Experimental_Data/yujunchen/projects/AI_IAPS/new_pipeline/roi_decoding_random10fold")
OUT = ROOT / "group"
...
def main() -> None:
    ...
    chart_data = {
        ...
        "chance": CHANCE,
        "cv_scheme": "random 10-fold x30 repeats (Bo et al. 2021 scheme)",
