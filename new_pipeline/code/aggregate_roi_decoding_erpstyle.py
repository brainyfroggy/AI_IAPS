#!/usr/bin/env python3
"""Aggregate per-subject ERP-style (averaged-trial) Kastner ROI decoding results (n=29,
GLMsingle single-trial betas) and add group-level statistics. Mirrors
aggregate_roi_decoding_random10fold.py exactly, pointed at the erpstyle output tree.
"""
...
ROOT = Path("/mnt/n/Experimental_Data/yujunchen/projects/AI_IAPS/new_pipeline/roi_decoding_erpstyle")
OUT = ROOT / "group"
...
def main() -> None:
    ...
    chart_data = {
        ...
        "chance": CHANCE,
        "cv_scheme": "ERP-style Avg(random): KFold(4) x 20 repeats, 3-group train averaging, applied to GLMsingle single-trial betas",
