...
for s=1:1
    ...
    nsess =6;
    mns=[0 0 0 0 0 0];% 10 runs
    %main effect
    cname{1} = 'Pl-AI_Pl';
    simp = [ 1 0 0 -1 0 0];
    cons{1} = [simp mov simp mov simp mov simp mov simp mov simp mov mns];
    ctype{1} = 'T';
    
    cname{2} = 'Nt-AI_Nt';
    simp = [ 0 1 0 0 -1 0];
    cons{2} = [simp mov simp mov simp mov simp mov simp mov simp mov mns];
    ctype{2} = 'T';
  
    cname{3} = 'Up-AI_Up';
    simp = [ 0 0 1 0 0 -1];
    cons{3} = [simp mov simp mov simp mov simp mov simp mov simp mov mns];
    ctype{3} = 'T';
    
    cname{4} = 'Pl-Nt';
    simp = [ 1 -1 0 0 0 0];
    cons{4} = [simp mov simp mov simp mov simp mov simp mov simp mov mns];
    ctype{4} = 'T';
    
    cname{5} = 'Up-Pl';
    simp = [ -1 0 1 0 0 0];
    cons{5} = [simp mov simp mov simp mov simp mov simp mov simp mov mns];
    ctype{5} = 'T';
  
    cname{6} = 'Up-Nt';
    simp = [ 0 -1 1 0 0 0];
    cons{6} = [simp mov simp mov simp mov simp mov simp mov simp mov mns];
    ctype{6} = 'T';
    
    cname{7} = 'AI_Pl-AI_Nt';
    simp = [ 0 0 0 1 -1 0];
    cons{7} = [simp mov simp mov simp mov simp mov simp mov simp mov mns];
    ctype{7} = 'T';
    
    cname{8} = 'AI_Up-AI_Pl';
    simp = [0 0 0 -1 0 1];
    cons{8} = [simp mov simp mov simp mov simp mov simp mov simp mov mns];
    ctype{8} = 'T';
  
    cname{9} = 'AI_Up-AI_Nt';
    simp = [ 0 0 0 0 -1 1];
    cons{9} = [simp mov simp mov simp mov simp mov simp mov simp mov mns];
    ctype {9} = 'T';
