...
datapath = 'N:\Experimental_Data\yujunchen\projects\AI_IAPS\GLM\betas';
subjects = {
    'Sub19'};
% subjects = {'Sub20', 'Sub21','Sub22','Sub23','Sub24','Sub25','Sub26', 'Sub27','Sub28','Sub29','Sub31'};
...
for s=1:nsub
    ...
    cname{10} = 'AI_Pl-Pl';
    simp = [ -1 0 0 1 0 0];
    cons{10} = [simp mov simp mov simp mov simp mov simp mov simp mov simp mov simp mov simp mov simp mov mns];
    ctype{10} = 'T';
    
    cname{11} = 'AI_Nt-Nt';
    simp = [ 0 -1 0 0 1 0];
    cons{11} = [simp mov simp mov simp mov simp mov simp mov simp mov simp mov simp mov simp mov simp mov mns];
    ctype{11} = 'T';
  
    cname{12} = 'AI_Up-Up';
    simp = [ 0 0 -1 0 0 1];
    cons{12} = [simp mov simp mov simp mov simp mov simp mov simp mov simp mov simp mov simp mov simp mov mns];
    ctype{12} = 'T';
