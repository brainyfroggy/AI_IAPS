...
nscan = [224,224,224,224];
subs = {'Sub3'};
nses = 4;                       % Total number of sessions/runs to be modeled, 1 in this case.
TR = 1.8;
...
for i = 1:numel(subs) %SUBJECT
    ...
    for  j = 1:numel(runs) %SESSION, OR RUN
        ...
        % version: original, no adjusting delays
